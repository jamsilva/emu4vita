...
#define GUI_DisableClipping vita2d_disable_clipping
...
// Texture
enum GuiTextureFormat
{
    GUI_TEXTURE_FORMAT_U8U8U8U8_ABGR = SCE_GXM_TEXTURE_FORMAT_U8U8U8U8_ABGR,
    GUI_TEXTURE_FORMAT_X8U8U8U8_1RGB = SCE_GXM_TEXTURE_FORMAT_X8U8U8U8_1RGB,
    GUI_TEXTURE_FORMAT_U5U6U5_RGB = SCE_GXM_TEXTURE_FORMAT_U5U6U5_RGB,
    GUI_TEXTURE_FORMAT_X1U5U5U5_1RGB = SCE_GXM_TEXTURE_FORMAT_X1U5U5U5_1RGB,
};

enum GuiTextureFilter
{
    GUI_TEXTURE_FILTER_POINT = SCE_GXM_TEXTURE_FILTER_POINT,
    GUI_TEXTURE_FILTER_LINEAR = SCE_GXM_TEXTURE_FILTER_LINEAR,
};
...
#define GUI_DrawTexturePartScalRotate(texture, x, y, tex_x, tex_y, tex_w, tex_h, x_scale, y_scale, rad) \
...
#define GUI_DrawTextureTintPartScalRotate(texture, x, y, tex_x, tex_y, tex_w, tex_h, x_scale, y_scale, rad, color) \
