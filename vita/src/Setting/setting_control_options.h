...
static OptionMenuItem key_map_option_items[] = {
    ...
    {STR_BUTTON_CROSS, (void *)RETRO_KEY_TO_BITMASK(RETRO_DEVICE_ID_JOYPAD_B), 0},
    {STR_BUTTON_CIRCLE, (void *)RETRO_KEY_TO_BITMASK(RETRO_DEVICE_ID_JOYPAD_A), 0},
    {STR_BUTTON_SQUARE, (void *)RETRO_KEY_TO_BITMASK(RETRO_DEVICE_ID_JOYPAD_Y), 0},
    {STR_BUTTON_TRIANGLE, (void *)RETRO_KEY_TO_BITMASK(RETRO_DEVICE_ID_JOYPAD_X), 0},
    {"L", (void *)RETRO_KEY_TO_BITMASK(RETRO_DEVICE_ID_JOYPAD_L), 0},
    {"R", (void *)RETRO_KEY_TO_BITMASK(RETRO_DEVICE_ID_JOYPAD_R), 0},
