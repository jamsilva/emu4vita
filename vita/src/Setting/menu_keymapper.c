...
static char emu_key_mapper_option_texts[24][256];
static char hot_key_mapper_option_texts[24][256];
...
#define STD_EMU_KEY_MAPPER_OPTION(text_idx, config_element)                                                                                                  \
    {                                                                                                                                                        \
        LANG_NULL, emu_key_mapper_option_texts[text_idx], emu_key_mapper_option_items, sizeof(emu_key_mapper_option_items) / sizeof(CheckBoxOptionMenuItem), \
...
#define STD_HOT_KEY_MAPPER_OPTION(text_idx, config_element)                                                                                                  \
    {                                                                                                                                                        \
        LANG_NULL, hot_key_mapper_option_texts[text_idx], hot_key_mapper_option_items, sizeof(hot_key_mapper_option_items) / sizeof(CheckBoxOptionMenuItem), \
