...
// 图形 (菜单条目)
StrArrayOption display_size_option = {&graphics_config.display_size, display_size_values, NULL, sizeof(display_size_values) / sizeof(char *), graphicsOptionUpdateCallback, NULL};
StrArrayOption aspect_ratio_option = {&graphics_config.aspect_ratio, aspect_ratio_values, NULL, sizeof(aspect_ratio_values) / sizeof(char *), graphicsOptionUpdateCallback, NULL};
#if defined(WANT_DISPLAY_ROTATE)
StrArrayOption display_rotate_option = {&graphics_config.display_rotate, display_rotate_values, NULL, sizeof(display_rotate_values) / sizeof(char *), graphicsOptionUpdateCallback, NULL};
#endif
StrArrayOption graphics_shader_option = {&graphics_config.graphics_shader, graphics_shader_values, NULL, sizeof(graphics_shader_values) / sizeof(char *), graphicsOptionUpdateCallback, NULL};
StrArrayOption graphics_smooth_option = {&graphics_config.graphics_smooth, no_yes_values, NULL, sizeof(no_yes_values) / sizeof(char *), graphicsOptionUpdateCallback, NULL};
StrArrayOption overlay_select_option = {&graphics_config.overlay_select, NULL, NULL, 0, graphicsOptionUpdateCallback, NULL};
StrArrayOption overlay_mode_option = {&graphics_config.overlay_mode, overlay_mode_values, NULL, sizeof(overlay_mode_values) / sizeof(char *), graphicsOptionUpdateCallback, NULL};
StrArrayOption show_fps_option = {&graphics_config.show_fps, no_yes_values, NULL, sizeof(no_yes_values) / sizeof(char *), graphicsOptionUpdateCallback, NULL};

// 控制 (菜单条目)
StrArrayOption ctrl_player_option = {&control_config.ctrl_player, NULL, ctrl_player_values, sizeof(ctrl_player_values) / sizeof(char *), (void *)controlOptionUpdateCallback, NULL};
...
StrArrayOption front_touch_pad_option = {&control_config.front_touch_pad, no_yes_values, NULL, sizeof(no_yes_values) / sizeof(char *), (void *)controlOptionUpdateCallback, NULL};
StrArrayOption back_touch_pad_option = {&control_config.back_touch_pad, no_yes_values, NULL, sizeof(no_yes_values) / sizeof(char *), (void *)controlOptionUpdateCallback, NULL};
...
// 杂项 (菜单条目)
StrArrayOption auto_save_load_option = {&misc_config.auto_save_load, no_yes_values, NULL, sizeof(no_yes_values) / sizeof(char *), miscOptionUpdateCallback, NULL};

// 程序 (菜单条目)
StrArrayOption preview_path_option = {&app_config.preview_path, preview_path_values, NULL, sizeof(preview_path_values) / sizeof(char *), previewOptionUpdateCallback, NULL};
StrArrayOption preview_style_option = {&app_config.preview_style, preview_style_values, NULL, sizeof(preview_style_values) / sizeof(char *), previewOptionUpdateCallback, NULL};
StrArrayOption app_log_option = {&app_config.app_log, no_yes_values, NULL, sizeof(no_yes_values) / sizeof(char *), appOptionUpdateCallback, NULL};
StrArrayOption core_log_option = {&app_config.core_log, no_yes_values, NULL, sizeof(no_yes_values) / sizeof(char *), appOptionUpdateCallback, NULL};
StrArrayOption show_log_option = {&app_config.show_log, no_yes_values, NULL, sizeof(no_yes_values) / sizeof(char *), appOptionUpdateCallback, NULL};
StrArrayOption language_option = {&app_config.language, NULL, NULL, 0, langOptionUpdateCallback, NULL};
